...
<ul class="product_list">
    ...
    while ($row = mysqli_fetch_array($query_pro)) {
        ?>
        <li>
            <a href="index.php?quanly=sanpham&id=<?php echo $row['id_sanpham'] ?> " style= "text-align:center">
                <img src="admincp/modules/quanlysp/uploads/<?php echo $row['hinhanh'] ?>">
                <p class="title_product" style="text-align:center">Tên sản phẩm
                    
                </p>
                <p><?php echo $row['tensanpham']  ?></p>
                <p class=" price_product" style="text-align:center">Giá:
